...
%SCENARIOEXAMPLE Example for use of scene simulator

  %% filename, in which to save the simulated data; just use the filename of this function (.mat suffix is appended)
  fileName = mfilename();
...
% %     %a second target:
% %     targetParam(2).lateralDistance = 5;
% %     targetParam(2).longitudinalDistance = 40;
% %     targetParam(2).relLateralVelocity = 0;
% %     targetParam(2).relLongitudinalVelocity = 5;
